# push-main
> Promove dev para main (produção) no GitHub e envia origin/main. Só quando o usuário pedir explicitamente. Invoque com `/push-main`.

1. Confirme com o usuário que o `dev` já foi validado/testado e que ele realmente quer promover para produção agora.
